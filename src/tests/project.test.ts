...
describe('project scaffold', () => {
  ...
  it('ships production game assets from public with normalized paths', () => {
    const requiredAssets = [
      ...
      join('public', 'menu', 'gk-goals-2.webp'),
      join('public', 'menu', 'gk-goals-3.webp'),
      join('public', 'menu', 'gk-goals-4.webp'),
      join('public', 'menu', 'gk-goals-5.webp'),
      join('public', 'menu', 'gk-save.webp'),
      join('public', 'menu', 'gk-save-2.webp'),
