...
describe('tournament hub scene integration', () => {
  ...
  it('renders penalty shootouts on the match-style field layout', () => {
    ...
    expect(attemptListSource).toContain("export const PENALTY_ATTEMPT_LIST_PLAYER_FONT_SIZE = '20px'");
    expect(attemptListSource).toContain("export const PENALTY_ATTEMPT_LIST_TITLE_FONT_SIZE = '22px'");
    expect(attemptListSource).toContain("export const PENALTY_ATTEMPT_LIST_MARKER_FONT_SIZE = '22px'");
