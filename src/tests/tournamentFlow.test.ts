...
describe('tournament hub scene integration', () => {
  ...
  it('renders penalty shootouts on the match-style field layout', () => {
    ...
    expect(attemptListSource).toContain('export const PENALTY_ATTEMPT_LIST_WIDTH = SIDE_CORRIDOR_WIDTH - 20');
    ...
    expect(attemptListSource).toContain("export const PENALTY_ATTEMPT_LIST_PLAYER_FONT_SIZE = '18px'");
