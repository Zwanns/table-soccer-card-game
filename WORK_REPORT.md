...
Ожидаемый результат в браузере: меню `Table Soccer` с кнопками `Новая игра` и `Правила`. Кнопка `Новая игра` открывает статический экран поля с фиктивными картами.
